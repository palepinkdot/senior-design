...
import { useLogoutUserMutation, useMeOrgQuery, useMeUserQuery } from "../../generated/graphql";
	...
	if (loading) {
		...
		userBody = (
			<Flex alignItems={"center"}>
				Hey, {data.meOrg.orgName}!
				<Menu>
					<MenuButton as={Button} rounded={"full"} variant={"link"} cursor={"pointer"}>
						<Avatar name={data.meOrg.orgName} size={"sm"} src={data.meOrg.avatarUrl} />
					</MenuButton>
					<MenuList>
						<MenuDivider />
						<MenuItem
