...
import {HStack, Link, Stack, Text, Flex, Image, VStack, Heading, StackDivider, Box} from "@chakra-ui/react";
    ...
    return (
        <>
            ...
            >
                ...
                >
                    ...
                    <Image
                        ...
                        p={4}
                        borderRadius={30}
                        src={"https://images.unsplash.com/photo-1593991910379-b414c1e3bd74?ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8YWRvcHR8ZW58MHx8MHx8&ixlib" +
                ...
                >
                    <Image
                        ...
                        p={4}
                        borderRadius={30}
                        src={"https://images.unsplash.com/photo-1598411072028-c4642d98352c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib" +
            ...
            >
                <Image
                    boxSize={"500px"}
                    src={"https://i.imgur.com/Xb5PPvU.png"}
                />
            </Stack>
                <Box
                    display="flex"
                    ...
                    <VStack alignItems="left" verticalAlign="top" spacing={3} paddingLeft="25px">
                        ...
                        <Text fontSize="lg">Jackson is a feisty little bugger that we rescued from a some dude's house. Ut enim ad
                            ...
                            occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</Text>
                        <Heading fontSize="2xl" fontWeight="900">
                            Animal Information
                        </Heading>
                        ...
                        >
                            ...
                            <HStack alignItems="center" spacing="142px">
                                ...
                                <Text fontSize="md">Doggo likes to eat hooves, careful if you have horses.</Text>
                            </HStack>
