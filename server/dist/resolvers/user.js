...
const UpdateUserInfoInput_1 = require("./UpdateUserInfoInput");
...
let UserResolver = class UserResolver {
    updateUserInfo(options, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const updatedUser = yield User_1.User.findOne({ where: { id: options.userid } });
            ...
            let user;
            try {
                const result = yield User_1.User.update({ id: options.userid }, {
            ...
            req.session.userId = updatedUser === null || updatedUser === void 0 ? void 0 : updatedUser.id;
            return { user };
        });
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [UpdateUserInfoInput_1.UpdateUserInfoInput, Object]),
